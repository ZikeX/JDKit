...
extension TableModel {
    /*************** 计算JDContentView高度 ***************/
    fileprivate func frameLayoutJDContentViewHeight(_ tableView:UITableView,tempCell:TableCell,contentWidth:CGFloat) -> CGFloat? {
    ...
    fileprivate func autoLayoutCellHeight(_ tableView:UITableView,tempCell:TableCell,contentWidth:CGFloat) -> CGFloat {
...
extension TableModel {
    ...
    fileprivate func getContentViewWidth(_ tableView:UITableView,cell:TableCell) -> CGFloat {
...
private var tempCells = [String:TableCell]()
extension TableModel { //tempCell
    fileprivate func getTempCell(_ tableView:UITableView) -> TableCell  {
        if let tempCell = tempCells[reuseIdentifier] {
            return tempCell
        }else {
            let tempCell = createCellWithTableView(tableView) as! TableCell
            tempCell.isTempCell = true
            tempCells[reuseIdentifier] = tempCell
            return tempCell
        }
    }
    fileprivate func bindingDataAndConstraint(_ tempCell:TableCell) {
